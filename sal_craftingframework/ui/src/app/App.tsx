      ...
      case 'cw_player_crafting_2560':
        return (
          <PlayerCrafting
            ...
            onOpenBlueprints={() => setCurrentFrame('cw_player_blueprints_1920')}
            onOpenQueue={() => setCurrentFrame('cw_player_queue_1920')}
            onClose={actions.close}
          />
        );
      case 'cw_player_blueprints_1920':
        return <PlayerBlueprints frameId={currentFrame} onClose={actions.close} onBack={() => setCurrentFrame('cw_player_crafting_1920')} />;
      case 'cw_player_queue_1920':
        return <PlayerQueue frameId={currentFrame} onClose={actions.close} onBack={() => setCurrentFrame('cw_player_crafting_1920')} />;
