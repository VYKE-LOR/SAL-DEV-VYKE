...
export const PlayerBlueprints: React.FC<PlayerBlueprintsProps> = ({ frameId, onClose, onBack }) => {
  const { state } = useNui();
  ...
  return (
    <div id={frameId} className="w-full h-full bg-cw-bg text-cw-text-primary overflow-hidden flex flex-col font-sans">
       <div id="cw_bp_root" className="flex flex-col h-full">
         <PlayerTopbar title="BLUEPRINTS" subtitle="Manage your schematics" onClose={onClose} onOpenQueue={onBack} />
