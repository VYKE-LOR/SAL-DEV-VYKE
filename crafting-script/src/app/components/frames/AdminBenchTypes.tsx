             ...
             <div id="ad_content" className="flex-1 flex p-8 gap-8 overflow-hidden">
                 ...
                 <div className="w-1/3 flex flex-col gap-4">
                     ...
                     <Card id="lst_admin_benchTypes" className="flex-1 overflow-y-auto p-2 flex flex-col gap-2">
                        {['workbench', 'ammo_press', 'chem_station'].map(type => (
                           <div key={type} id={`row_benchType__${type}`} className="p-3 flex items-center justify-between rounded-lg hover:bg-cw-surface-2 cursor-pointer border border-transparent hover:border-cw-primary/30 transition-all group">
