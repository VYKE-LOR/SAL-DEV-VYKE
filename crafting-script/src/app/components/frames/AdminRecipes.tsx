                ...
                <div id="ad_split_layout" className="w-full h-full flex">
                   ...
                   <div id="ad_list_panel" className="w-80 border-r border-cw-border bg-cw-surface-1/30 flex flex-col">
                      ...
                      <div id="lst_admin_recipes" className="flex-1 overflow-y-auto p-2 flex flex-col gap-2">
                         {['Assault Rifle', 'Pistol Ammo', 'Bandage'].map((name, i) => (
                            <div key={i} id={`row_admin_recipe__${i}`} className="p-3 rounded-lg hover:bg-cw-surface-2 group cursor-pointer border border-transparent hover:border-cw-primary/30 transition-all">
                               <div className="flex justify-between items-start mb-1">
                                  <span id="txt_admin_recipe_name" className="font-bold text-sm text-cw-text-primary">{name}</span>
                               ...
                               <div className="flex gap-1">
                                  <Badge id="badge_admin_recipe_category" variant="outline" className="text-[10px] py-0">Weapons</Badge>
                                  <Badge id="badge_admin_recipe_level" variant="secondary" className="text-[10px] py-0">Lvl 3</Badge>
                               </div>
                            </div>
                         ))}
                      </div>
